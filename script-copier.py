r"""
script-copier.py
Recursively scans d:\VEGA\VEGA_AUTH\backend\src\main\java\com\vega (and sub-paths),
reads every source file, and writes their contents into expired-marketdata.md
...
EXCLUDE_DIRS = {
    Path(r"D:\VEGA\VEGA_RRG\backend\src\test"),
    Path(r"D:\VEGA\VEGA_RRG\backend\target"),
    Path(r"D:\VEGA\VEGA_RRG\frontend\node_modules"),
    
}
OUTPUT_FILE = Path(r"D:\VEGA\VEGA_RRG\rrg.md")
